    ...
    <nav className="sticky top-0 z-50 bg-white shadow-md w-full">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          {/* Logo and Site Name */}
          <Link to="/" className="flex items-center space-x-2 text-brand-blue">
            <span className="font-bold text-xl">FadPlus</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <Button className="bg-brand-blue hover:bg-blue-700" asChild>
        ...
        {isOpen && (
          <div className="md:hidden py-4 space-y-2 animate-fade-in">
            ...
            <div className="flex flex-col pt-2 space-y-2 border-t border-gray-200">
              ...
              <Button className="w-full justify-start bg-brand-blue hover:bg-blue-700" asChild>
...
const NavLink = ({ to, label, icon, onClick }: NavLinkProps) => {
  return (
    <Link
      to={to}
      className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-brand-blue hover:bg-gray-100 flex items-center gap-1 transition-colors"
      onClick={onClick}
    >
      {icon}
      {label}
...
const MobileNavLink = ({ to, label, icon, onClick }: NavLinkProps) => {
  return (
    <Link
      to={to}
      className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-brand-blue hover:bg-gray-100 flex items-center gap-2"
      onClick={onClick}
    >
      {icon}
      {label}
